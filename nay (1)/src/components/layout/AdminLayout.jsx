        ...
        <Navbar fluid rounded style={{ backgroundColor: "paleturquoise" }}>
          ...
          <div className="flex md:order-2">
            <Dropdown
              ...
              inline
              label={
                <Avatar alt="User settings" img="https://avatars.githubusercontent.com/u/132586195?v=4" rounded />
              }
            >
              <Dropdown.Header>
                <span className="block text-sm">Nay HB</span>
                <span className="block truncate text-sm font-medium">nieobehb2904@gmail.com</span>
              </Dropdown.Header>
